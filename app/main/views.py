...
def unfollow(username):
    ...
    flash("Now you are  unfollowing this user")
    return redirect(url_for('.user',username=username))
...
def followers(username):
    ...
    return render_template('follower.html',user=user,title='Followers of',endpoint='.followers',pagination =pagination,follows=follows)
...
def followed_by(username):
    ...
    return render_template('following.html',user=user,title='Following of',endpoint='.following',pagination =pagination,followed=followed)
